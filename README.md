...
<a href="#fig1">Визуализация объекта с освещением</a> 
<a href="#fig2">Визуализация объекта с отключённым освещением</a> 
<a href="#fig3">Альфа-прозрачность</a> 
<a href="#fig4">Перемещение источника света</a>
